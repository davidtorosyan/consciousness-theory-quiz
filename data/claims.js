...
window.CLAIMS = Object.freeze([
  ...
  },
  {
    ...
    text: "Consciousness is the electromagnetic field the whole brain generates together — the field itself, not merely the neurons firing that produce it.",
...
,
  ...
  },
  {
    ...
    text: "Conscious experience shows up only when the brain's electromagnetic fields organize into specific layered, nested patterns — those field patterns are what experience is made of, and neurons firing alone don't add up to it.",
    plain: "Experience appears when the brain's fields fall into the right nested patterns. The patterns are what experience is made of — neurons alone aren't enough.",
    entails: ["c50"]
  },
  {
    id: "c201",
  ...
  },
  {
    ...
    text: "Massively parallel signals looping back and forth — 'reentrant signaling' — between clusters of neurons, especially between the thalamus and the cortex, weave distributed brain areas into one unified, ever-changing core. Its shifting, semi-stable states carry the moment-to-moment unity of experience.",
  ...
  },
  {
    ...
    text: "What philosophers call 'qualia' (the felt quality of experience — what red feels like) are fine-grained distinctions — very precise ways of telling signals apart — made by neural systems: differences in what something feels like are differences in the neural structure and dynamics underlying it.",
  ...
  },
  {
    ...
    text: "Our common-sense psychology — beliefs, desires, and the rest of its mind-talk ('mentalistic vocabulary') — is a radically false theory, so defective that completed neuroscience will displace it entirely rather than smoothly reduce it.",
  ...
  },
  {
    ...
    text: "Start by carefully describing lived experience \u2014 what things are like from the inside \u2014 not by explaining brains or metaphysics.",
  ...
  },
  {
    ...
    text: "Mind and matter are two faces of one deeper reality \u2014 something underneath that is neither mind nor matter, but gives rise to both.",
  ...
  },
  {
    ...
    text: "Consciousness depends on quantum physics \u2014 the strange physics of the very, very small. Ordinary, everyday-scale physics can\u2019t explain it.",
