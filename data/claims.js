...
,
  ...
  },
  {
    ...
    text: "At the most fundamental level there is 'consciousness*' — what others would call protoconsciousness, a simpler precursor form of consciousness — and it is irreducible: there is no plausible reductive physical candidate for it.",
...
window.CLAIM_THEORIES = Object.freeze([
  ...
  { id: 19, name: "Integrated Information Theory", blurb: "Consciousness is how integrated a system's cause-and-effect structure is.",   family: "Information",   aliases: ["Tononi"], caveat: "This theory starts from consciousness itself and defines 'physical' very broadly — as anything with cause-and-effect power, not just ordinary matter. So placing it under 'ordinary matter and physics is enough' was our judgment call; a reasonable map could file it elsewhere.",   claims: ["c12", "c14"] },
  ...
  { id: 38, name: "T. Campbell's Big TOE (Theory of Everything)", blurb: "Reality is a virtual world computed by a Larger Consciousness System; we play to evolve.", family: "Idealism", claims: ["c142","c143"], caveat: "Campbell rejects the 'idealism' label — he presents this as a virtual-reality model rather than idealism; filed here by structural analogy." },
  ...
  { id: 91, name: "Bunge's emergent materialism", blurb: "No soul, no mystery-stuff: mind is what a learning brain does — an emergent but wholly material property of neural systems.", family: "Materialism", claims: ["c221"], caveat: "Bunge is a materialist but not a physicalist: he holds that physics cannot fully explain life or mind, so his claims deliberately stop short of saying ordinary physics is enough." },
  ...
  { id: 97, name: "Metzinger's no-self theory", blurb: "Felt experience is real, but the 'self' having it isn't — it's a transparent brain-model of a subject.", family: "Materialism", claims: ["c235","c236"], caveat: "Metzinger affirms felt experience with a causal role — he is not an illusionist. His distinctive claims here concern the self-model, not the reality of experience. Kept under Materialism by landscape convention (CTT files him under Eliminative/Materialism), not by fit with eliminativism." },
  ...
  { id: 102, name: "Blackmore's \"it's all models\"", blurb: "Nobody is conscious — only the predictive models inside you are. 'Becoming conscious' is a model joining your self-model.", family: "Materialism", claims: ["c244"], caveat: "The CTT landscape files Blackmore under Eliminative/Illusionism, but 'all models are conscious' has a panpsychist-of-models flavor and she keeps 'what it is like' language for models. She is a 'delusionist' about the conscious subject, not a standard illusionist — so her claims stop short of saying felt qualities are unreal." },
  { id: 103, name: "Kammerer's introspective illusionism", blurb: "Conscious experience doesn't exist — it only seems to, because introspection is rigged to paint brain states as special.", family: "Materialism", claims: ["c245"], caveat: "Kammerer argues illusionism makes the best case for physicalism, but his distinctive claims are about introspection's unreliability (the TCE theory), not about physics — so they stop short of saying ordinary physics is enough." },
  { id: 104, name: "Mandik's qualia quietism", blurb: "Conscious experience is real — but the word 'qualia' (the supposed 'felt qualities' of experience) is empty, so stop arguing about whether qualia exist or not.", family: "Materialism", claims: ["c246","c108","c228"], caveat: "Mandik explicitly rejects standard physicalism ('I'm not a physicalist') and takes neither a realist nor an eliminativist position on qualia; Materialism is the Closer to Truth landscape label, not a fit — his claims stop short of saying ordinary physics is enough or that felt qualities are unreal. His self-representationalism treats the representing as built into the state itself, like Kriegel's." },
  { id: 105, name: "Irvine's scientific eliminativism", blurb: "'Consciousness' isn't one thing — it's a loose cluster of capacities, and science should drop the word and study measurable abilities instead.", family: "Materialism", claims: ["c248","c249"], caveat: "Irvine's eliminativism is methodological, not metaphysical: drop the term from science rather than chase one essence. She does not deny experience outright — so her claims stop short of saying felt qualities are unreal — and she makes no physics claim, so they stop short of saying ordinary physics is enough either." },
  ...
  { id: 118, name: "Husserl's transcendental phenomenology", blurb: "Before explaining consciousness, describe it properly: every experience is about something, and bracketing our assumptions reveals the deep structures of time, meaning, and the shared world.", family: "Phenomenology", claims: ["c271","c272"], caveat: "Phenomenology is a descriptive method, not a metaphysics: Husserl deliberately brackets whether the world exists as it appears, so these claims take no stance for or against materialism — they stop short of saying ordinary physics is enough." },
  { id: 119, name: "Merleau-Ponty's lived body", blurb: "You are not a mind piloting a body — your body is the perceiver: meaning reaches you through the body first, as urges and possibilities, before any thought.", family: "Phenomenology", claims: ["c274"], caveat: "Merleau-Ponty's project is phenomenological description, not mechanism: these claims are about how the world shows up in bodily life, not about what the brain computes — they make no 'ordinary physics is enough' claim, consistent with his rejection of both empiricism and intellectualism." },
